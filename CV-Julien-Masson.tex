...
\cvaddress{San Francisco, United States} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{(650) 448-8570} % Phone numbe
...
\medskip
\mycvevent{Linux Developer}{Facebook}{February 2018 -- Ongoing}{Silicon Valley, United States}
\medskip
...
{\large{\color{maingray}\bullet}\makebox[0.5\linewidth][l]{\color{black}\hspace{0.5em}Write windows manager for Linux}}
...
{\large{\color{maingray}\bullet}\makebox[0.5\linewidth][l]{\color{black}\hspace{0.5em}Hack Emacs module}}
